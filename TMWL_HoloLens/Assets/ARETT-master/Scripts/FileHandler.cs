...
namespace ARETT
{
	...
	public class FileHandler : IFileHandler
	{
		...
		/// <summary>
		/// Is the previous audioInterval to write data still busy?
		/// </summary>
		...
		/// <summary>
		/// CueName of the current participant
		/// </summary>
		private string currentParticipantName = "";
		/// <summary>
		/// CueName of the current recording
		/// </summary>
		private string currentRecordingName = "";
		/// <summary>
		/// Time at which the recording trialRunning and which is used in the filename
		/// </summary>
		...
		public void StartDataLog(string participantName, string recordingName)
		{
			...
			// Hook up the write function to the audioInterval. 
			dataWriteTimer.Elapsed += flushDataQueue;
			dataWriteTimer.AutoReset = true;

			// Start the audioInterval
		...
		public void StopDataLog()
		{
			...
			// Stop the audioInterval and dispose of it
			dataWriteTimer.Stop();
