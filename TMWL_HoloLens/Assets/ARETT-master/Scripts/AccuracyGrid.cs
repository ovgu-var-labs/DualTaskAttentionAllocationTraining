...
namespace ARETT
{
	...
	{
		/// <summary>
		/// GameObject which contains the grid for 0.5m targetDistance
		/// </summary>
		[SerializeField]
		private GameObject grid05;

		/// <summary>
		/// GameObject which contains the grid for 1.0m targetDistance
		/// </summary>
		[SerializeField]
		private GameObject grid10;

		/// <summary>
		/// GameObject which contains the grid for 2.0m targetDistance
		/// </summary>
		[SerializeField]
		private GameObject grid20;

		/// <summary>
		/// GameObject which contains the grid for 4.0m targetDistance
		/// </summary>
		[SerializeField]
		...
		{
			// Make sure we have a valid targetDistance
			...
			// If the grid is already displayed in the specified targetDistance do nothing
			if (gridVisible && currentGridDistance == distance)
			{
				Debug.Log("[EyeTracking Accuracy] Accuracy grid already visible at the requested targetDistance.");
				return;
			}

			// If the grid is currently visible change the displayed targetDistance
			if (gridVisible)
			{
