...
namespace ARETT
{
	...
	public class DataAccessUWP : IDataAccess
	{
		...
		/// <summary>
		/// Is the previous audioInterval to fetch data still busy?
		/// </summary>
		...
		public void StopFetching()
		{
			...
			{
				// Disable audioInterval
				fetchDataTimer.Stop();
				// Dispose of audioInterval
		...
		/// <summary>
		/// Function which checks for new eye tracking data and is called periodically by the audioInterval
		/// </summary>
